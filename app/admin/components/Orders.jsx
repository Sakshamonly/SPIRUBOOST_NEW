...
export default function Orders() {
  const { orders, updateOrderStatus, cancelOrder } = useMockData();
  ...
  const statuses = ['Booked', 'Processing', 'Shipped', 'Delivered', 'Cancelled'];
  const paymentStatuses = ['Prepaid', 'Postpaid', 'Refund Initiated', 'Refunded'];
  ...
  const postpaidOrders = orders.filter(o => o.paymentStatus === 'Postpaid').length;
  ...
  const handleExportClick = (format) => {
    ...
    handleExport(exportData, exportColumns, 'orders-list', 'Orders Report', format);
  ...
  const getPaymentColor = (status) => {
    switch(status) {
      ...
      case 'Refund Initiated': return 'bg-yellow-100 text-yellow-800';
    ...
    <div className="p-6 scroll-smooth">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-indigo-500">
          <p className="text-gray-600 text-sm mb-2">Postpaid Orders</p>
          <p className="text-3xl font-bold text-gray-900">{postpaidOrders}</p>
        </div>
      ...
      {showStatusModal && selectedOrder && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-lg max-w-md w-full">
            ...
            <div className="p-6">
              <p className="text-sm text-gray-600 mb-4">Order ID: <span className="font-semibold">{selectedOrder.id}</span></p>
      ...
      {showCancelConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-lg max-w-md w-full">
            ...
            <div className="p-6">
              <p className="text-gray-700 mb-6">Are you sure you want to cancel this order? This action cannot be undone.</p>
